...
function h1Animation(elem) {
var clutter = "";

  document.querySelector(elem).textContent.split(" ").forEach(function(dets){
  clutter += `<span> ${dets} </span>`

  document.querySelector(elem).innerHTML = clutter;
})
